...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-slate-800  sticky  top-0 z-50 flex items-center w-full  px-6 sm:px-64 py-4 text-white">
        <button
        ...
        <ul className={`${menuOpen ? "flex" : "hidden"} absolute sm:static left-0 py-4 text-xl top-14 w-full border-t-2 border-purple-300 sm:w-auto bg-slate-800 sm:items-center sm:gap-10 font-semibold`} >
